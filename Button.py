...
class Button:
    ...
    def __init__(self, win, center, width, height, color, label):
        ...
        self.button_outline = Rectangle(Point(self.center.getX() - self.width / 2, self.center.getY(
        ) - self.height / 2), Point(self.center.getX() + self.width / 2, self.center.getY() + self.height / 2))
